...
export default function CreatePost() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('posts.store'), {
            preserveScroll: true,
            onSuccess: () => reset(),
            onError: () => console.log(errors), // Optional: log errors for debugging
        });
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="container mx-auto max-w-2xl p-6">
                ...
                <div className="hover:shadow-3xl perspective-1000 relative transform rounded-xl bg-white p-6 shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:rotate-x-2 dark:bg-neutral-800">
                    <h1 className="mb-6 text-center text-3xl font-bold text-gray-800 dark:text-gray-100">Create a New Post</h1>
